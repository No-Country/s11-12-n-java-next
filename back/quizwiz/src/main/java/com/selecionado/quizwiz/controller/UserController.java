...
public class UserController {
	...
	@PostMapping()
	public ResponseEntity<HttpStatus> saveUser(@RequestBody UserDtoRe userDTO) throws ExistsEmailException, ConfirmPasswordException, UserIDNotFoundException {
	...
	@PutMapping()
	public ResponseEntity<HttpStatus> updateUser(@RequestBody UserDtoRe userDTO) throws UserIDNotFoundException, ExistsEmailException, ConfirmPasswordException{
